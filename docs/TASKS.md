...
- [ ] **WS 113 — Configure Environment Variables**
  > DoD:
...
- [ ] **WS 121 — Provision AWS RDS MySQL Instance**
  > DoD:
...
- [ ] **WS 122 — Implement Async DB Connection (`db/connection.py`)**
...
- [ ] **WS 123 — Implement ORM Models (`db/models.py`)**
...
- [ ] **WS 124 — Implement Repository CRUD Helpers (`db/repository.py`)**
...
- [ ] **WS 125 — Verify Tables Auto-Created on Startup**
